      ...
      <div style={{ marginTop: 12 }}>
        <Field label="Description">
          ...
          <p style={{ fontSize: 10, color: '#444', marginTop: 4, lineHeight: 1.5 }}>
            Formatting: <code style={{ color: '#39FF14', background: '#111', padding: '0 4px', borderRadius: 2 }}>**bold**</code>{' '}
            <code style={{ color: '#39FF14', background: '#111', padding: '0 4px', borderRadius: 2 }}>*italic*</code>{' '}
      ...
      {activeTab === 'info' && (
        editing ? (
          ...
          <div style={s.card}>
            ...
            <div style={s.g2}>
              {[['Title', car.title], ['Slug', car.slug], ['Brand', car.brand_data?.name || car.brand || '—'], ['Subtitle', car.subtitle || '—'], ['Cover Image', car.cover_image || '—']].map(([label, val]) => (
